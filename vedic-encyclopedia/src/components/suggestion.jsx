'use client'
import { sendmsg } from "@/actions/suggest"
...
export default function TypeDropdown (){
  ...
  return (
    <form action={sendmsg} className=' my-[7rem] mx-[9vh] w-[160vh] h-[110vh] outline-5 outline-[#fffbeb] border-1 border-solid border-orange-700 bg-[#cb925a]/30 backdrop-brightness-100 backdrop-invert backdrop-opacity-[-10] backdrop-blur-xs drop-shadow-xl rounded-lg backdrop-brightness-20 drop-shadow-xl/20 h-[25rem] '>
      <div className="flex-col justify-items-center pt-5">
      <h1 className='pt-[20px] antialiased font-serif text-orange-900 text-4xl'>We Would Love Hearing From You !</h1>
      ...
      <div className="flex flex-col justify-items-start mb-5"> 
        <label className="font-bold text-orange-900 text-lg ml-[24vh] mt-10">Type</label>
      ...
      <textarea name="category" placeholder="Enter Category"  required className='bg-[#fed7aa] pl-2 pt-[0.4rem] mx-[25vh] mb-5 text-[#78350f] focus:outline-none font-medium resize-none select-all w-[40rem] h-[7vh] mt-2 flex border-2 rounded-sm border-[#d97706]'></textarea>
      <label className="font-bold text-orange-900 text-lg ml-[24vh]">Message</label>
      <textarea name='message' placeholder='Kindly Share Your Suggestions or Feedback...' required className='bg-[#fed7aa] py-[10px] pl-[10px] mx-[25vh] mb-10 focus:outline-none text-[#78350f] font-medium resize-none select-all w-[40rem] h-[20vh] mt-2 flex justify-center border-2 rounded-sm border-[#d97706]'></textarea>
